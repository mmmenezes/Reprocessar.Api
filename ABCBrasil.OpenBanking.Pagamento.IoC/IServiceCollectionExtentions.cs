...
using ABCBrasil.OpenBanking.Pagamento.Core.Interfaces.Common;
...
using ABCBrasil.OpenBanking.Pagamento.Core.Pagamento;
using ABCBrasil.OpenBanking.Pagamento.Core.Services;
using ABCBrasil.OpenBanking.Pagamento.Infra.Cache;
using ABCBrasil.OpenBanking.Pagamento.Infra.ExternalApis;
using ABCBrasil.OpenBanking.Pagamento.Infra.Repository;
...
namespace ABCBrasil.OpenBanking.Pagamento.IoC
{
    public static class IServiceCollectionExtentions
    {
        ...
        static IServiceCollection AddServices(this IServiceCollection builder)
        {
            ...
            builder.AddHttpClient<ICalendarService, CalendarService>();
            builder.AddScoped<IValidacaoPagamentoService, ValidacaoPagamentoService>();
            builder.AddScoped<IPaymentCodeExtractorService, PaymentCodeExtractorService>();
