...
using ABCBrasil.Core.Pagamento.Dsl.LIB.Models;
...
namespace ABCBrasil.OpenBanking.Pagamento.Core.Pagamento
{
    public class PagamentoValida : ServiceBase, IPagamentoValida
    {
        ...
        public PagamentoValida(
            ...
            IValidacaoPagamentoService libService) : base(issuer)
        {
        ...
        public bool ValidaTipoAutenticacaoValorDivergente(Models.Pagamento pagamento, CalculaTituloResponse retornoCalculo)
        {
            ...
            try
            {
                ...
                ABCBrasil.Core.Pagamento.Dsl.LIB.Models.CIP.CipXml xmlConvertido = _libService.ConverteObjetoCipxCalculo(retornoCalculo.RespostaConsultaCip.XmlR1);
                xmlConvertido.Autbank = JsonConvert.DeserializeObject<ABCBrasil.Core.Pagamento.Dsl.LIB.Models.CIP.RespostaAutbank>(JsonConvert.SerializeObject(calculoCip));
